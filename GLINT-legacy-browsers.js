...
function loading_instructionsRoutineBegin(snapshot) {
  return async function () {
    ...
    loading_instructionsComponents.forEach( function(thisComponent) {
...
function intro_practiceRoutineBegin(snapshot) {
  return async function () {
    ...
    intro_practiceComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function intro_practice_2RoutineBegin(snapshot) {
  return async function () {
    ...
    intro_practice_2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function randomize_blocksLoopBegin(randomize_blocksLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    randomize_blocks.forEach(function() {
...
function prac_fixRoutineBegin(snapshot) {
  return async function () {
    ...
    prac_fixComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function prac_stimRoutineBegin(snapshot) {
  return async function () {
    ...
    prac_stimComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function prac_maskRoutineBegin(snapshot) {
  return async function () {
    ...
    prac_maskComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function prac_promptRoutineBegin(snapshot) {
  return async function () {
    ...
    prac_promptComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function img_set_loaderRoutineBegin(snapshot) {
  return async function () {
    ...
    img_set_loaderComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function instructions_testRoutineBegin(snapshot) {
  return async function () {
    ...
    instructions_testComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function intro_experimentRoutineBegin(snapshot) {
  return async function () {
    ...
    intro_experimentComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function correctRoutineBegin(snapshot) {
  return async function () {
    ...
    correctComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
